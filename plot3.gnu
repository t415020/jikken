...
# の順で書かれているものとする。
# ここでは呼量(a)とデータ廃棄率(B)のグラフを描く
plot "S_and_F_5" using 2:3 with linespoints, \
     "S_and_F_6" using 2:3 with linespoints, \
     "S_and_F_7" using 2:3 with linespoints, \
     "S_and_F_8" using 2:3 with linespoints
